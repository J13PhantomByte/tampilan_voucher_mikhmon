...
<tbody>
<tr>
<td style="color:<?php echo $color; ?>;" valign="top">
...
<tr>
<td style="color:<?php echo $color; ?>;border-collapse: collapse;" valign="top">
...
Hubungkan ke WIFI TOKO JUAN
Buka brouser ketik  : juan.net
</div>
</td>	
...
<tr>
<td style="background:<?php echo $color ?>;color:#fff;padding:0px;" valign="top" colspan="2">
<div style="text-align:left;color:#fff;font-size:9px;font-weight:bold;margin:0px;padding:2.5px;">
CS: <b>0800-0000-0000</b>
</div>
</td>
</tr>
</tbody>
